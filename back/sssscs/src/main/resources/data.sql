...
insert into certificate (status, subject_data_common_name, type, valid_from, valid_to, owner_id, parent_id) values('GOOD', 'root', 'ROOT', '2021-01-01', '2023-12-06', 1, null);
insert into certificate (status, subject_data_common_name, type, valid_from, valid_to, owner_id, parent_id) values('GOOD', 'end', 'END', '2021-01-01', '2023-12-06', 2, 1);